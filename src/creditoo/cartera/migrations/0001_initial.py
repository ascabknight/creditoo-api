    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_departamento', models.CharField(max_length=100, verbose_name='Nombre Departamento')),
                ('nombre_ciudad', models.CharField(max_length=100, verbose_name='Nombre Ciudad')),
                ('nombre_barrio', models.CharField(max_length=100, verbose_name='Nombre Barrio')),
